...
api_t device_api[] =
{
    ...
    {"get_adc", adc_callback, "get voltage"},
    {"get_temp", temp_callback, "get temperature"},
    {"tm_start", tm_start_callback, "start measuring"},
    {"tm_stop", tm_stop_callback, "stop measuring"},
	{NULL, NULL, NULL}, 
};
